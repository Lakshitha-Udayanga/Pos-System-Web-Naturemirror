<div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="modalTitle"> @lang('Cheque details') (<b>@lang('Cheque Number')
        ...
        <div class="modal-body">
            <div class="row invoice-info">
                <div class="col-sm-4 invoice-col">
                    <b>@lang('Cheque number'):</b> #{{ $cheque->cheque_number }}<br/>
                    <b>@lang('messages.date'):</b> {{ @format_date($cheque->cheque_date) }}<br/>
                    <b>@lang('Issued date'):</b> {{ @format_date($cheque->cheque_issued_date) }}<br/>
                    <b>@lang('sale.status'):</b> {{ $cheque->cheque_status }}<br/>
                    <b>@lang('Cheque type'):</b> {{ $cheque->cheque_status }}<br/>
                        ...
                        <table class="table bg-gray">
                            ...
                            @foreach($cheque_transactions as $cheque_transaction)
                                <tr>
                                    ...
                                    <td>{{ number_format($cheque_transaction->cheque_amount, 2) }}</td>
