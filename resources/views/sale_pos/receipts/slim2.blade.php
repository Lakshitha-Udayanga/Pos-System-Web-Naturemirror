...
<body>
    <div class="ticket">
        ...
        <div class="border-top textbox-info">
            ...
            <p class="f-right">
                <span class="invoice_infor_header">{!! $receipt_details->invoice_no_prefix !!}: </span><span
                    class="invoice_info_details">{{ $receipt_details->invoice_no }}</span>
            </p>
        </div>
        <div class="textbox-info">
            {{-- <p class="f-left"><strong>{!! $receipt_details->date_label !!}</strong></p> --}}
            <p class="f-right">
                <span class="invoice_infor_header">{!! $receipt_details->date_label !!}: </span><span
                    class="invoice_info_details">{{ $receipt_details->invoice_date }}</span>
            </p>
        </div>
        ...
        <div class="customer_infor">
            <p style="vertical-align: top;">
                <span class="customer_lable">
                    {{ $receipt_details->customer_label ?? '' }}
                </span>
            </p>
            <p>
                @if (!empty($receipt_details->customer_info))
                    <div class="bw customer_infor">
                    ...
                    <tr class="bb-lg">
                        <td class="description">
                            <div style="display:flex; width: 100%;">
                                <p class="m-0 mt-5 table_infor" style="white-space: nowrap;">#{{ $loop->iteration }}.&nbsp;</p>
                                <p class="text-left m-0 mt-5 pull-left table_infor">{{ $line['name'] }}
                            ...
                            <div style="display:flex; width: 100%;">
                                <p class="text-left width-60 quantity m-0 bw table_infor" style="direction: ltr;">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    {{ $line['quantity'] }}
                                ...
                                @if (empty($receipt_details->hide_price))
                                    <p class="text-right width-40 price m-0 bw table_infor">{{ $line['line_total'] }}</p>
                                @endif
                            </div>
                        </td>
                    </tr>
        ...
        @if (empty($receipt_details->hide_price))
            <div class="flex-box">
                <p class="left text-left">
                    <strong class="price_infor">{!! $receipt_details->subtotal_label !!}</strong>
                </p>
                <p class="width-50 text-right">
                    <strong class="price_infor">{{ $receipt_details->subtotal }}</strong>
                </p>
            </div>
            ...
            <div class="flex-box">
                <p class="width-50 text-left">
                    <strong class="price_infor">{!! $receipt_details->total_label !!}</strong>
                </p>
                <p class="width-50 text-right">
                    <strong class="price_infor">{{ $receipt_details->total }}</strong>
                </p>
            </div>
            ...
            @if (!empty($receipt_details->total_paid))
                <div class="flex-box">
                    <p class="width-50 text-left price_infor">
                        {!! $receipt_details->total_paid_label !!}
                    </p>
                    <p class="width-50 text-right price_infor">
