		...
		<div class="form-group">
			...
			<div class="input-group">
              <span class="input-group-addon">
				...
				{!! Form::text("payment[$row_index][cheque_issued_date]", isset($payment_line['paid_on']) ? @format_datetime($payment_line['paid_on']) : @format_datetime('now'), ['class' => 'form-control new_cheque_date', 'readonly', 'required']); !!}
			</div>
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			<label for="cheque_type_{{$row_index}}">@lang('Cheque Type'):*</label>
