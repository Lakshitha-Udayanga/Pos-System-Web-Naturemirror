<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('SaleBulkReturnController@createPayment'), 'method' => 'post', 'id' => 'transaction_payment_add_form', 'files' => true ]) !!}
    ...
    <div class="modal-body">
      ...
      <div class="row payment_row">
        ...
        <div class="clearfix"></div>
          @include('sell_bulk_return.partials.payment_type_details')
        <div class="col-md-12">
          <div class="form-group">
