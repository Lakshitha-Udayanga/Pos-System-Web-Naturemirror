<tr class="product_row">
    ...
    <td>
        <input type="text" class="form-control return_qty" name="products[{{$row_index}}][return_quantity]" value="0.00">
        {{$product->unit}}
    </td>
    <td>
        ...
        <input type="text" class="form-control product_quantity input_number input_quantity" value="0.00" name="products[{{$row_index}}][quantity]" 
    ...
    <td>
        <input type="text" name="products[{{$row_index}}][unit_price]" class="form-control product_unit_price input_number" value="{{@num_format($product->selling_price)}}">
    </td>
    <td>
        <input type="text" readonly name="products[{{$row_index}}][price]" class="form-control product_line_total" value="0">
    </td>
