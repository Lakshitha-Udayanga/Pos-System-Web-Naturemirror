<div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="modalTitle"> @lang('Bulk return details') (<b>@lang('purchase.ref_no'):</b>
                #{{ $stock_adjustment->ref_no }})
            </h4>
        </div>
            ...
            <div class="row invoice-info">
                <div class="col-sm-4 invoice-col">
                    ...
                    <address>
                        ...
                        @endif
                        @if (!empty($stock_adjustment->location->city) ||
                ...
                <div class="col-sm-4 invoice-col">
                    ...
                    <b>@lang('Customer'):</b> {{ $customer->supplier_business_name }}<br>
                    ...
                    <div class="table-responsive">
                        <table class="table table-condensed bg-gray">
                            <tr class="bg-green">
                                ...
                                <th>Line Total Return</th>
                                <th>Line Total Replace</th>
                            </tr>
                                ...
                                <tr>
                                    ...
                                    {{-- @if (!empty($lot_n_exp_enabled))
                                        <td>{{ $stock_adjustment_line->lot_details->lot_number ?? '--' }}
                                            @if (session()->get('business.enable_product_expiry') == 1 &&
                                                !empty($stock_adjustment_line->lot_details->exp_date))
                                                ({{ @format_date($stock_adjustment_line->lot_details->exp_date) }})
                                            @endif
                                        </td>
                                    @endif --}}
                                    <td>
                                        {{ @format_quantity($stock_adjustment_line->bulk_return_quantity) }}
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        {{ @num_format($stock_adjustment_line->unit_price * $stock_adjustment_line->bulk_return_quantity) }}
                                    </td>
                                    <td>
                    ...
                    <div class="table-responsive">
                        <table class="table no-border">
                            <tr>
                                ...
                                <td><span class="display_currency pull-right" data-currency_symbol="true">{{ ($stock_adjustment->final_total + $stock_adjustment->bulk_return_payment_amount) }}</span></td>
                            </tr>
                            <tr>
                                <th>@lang('Total Replace'): </th>
                            ...
                            <tr>
                                ...
                                <td><span class="display_currency pull-right" data-currency_symbol="true">{{ $stock_adjustment->bulk_return_payment_amount }}</span></td>
                            </tr>
                        </table>
                    </div>
                </div>
