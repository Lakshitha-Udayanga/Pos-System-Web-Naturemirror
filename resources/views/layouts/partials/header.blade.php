...
<header class="main-header no-print">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            ...
            @if ($business->sms_dashbord_url != '')
                {{-- If the customer has taken the SMS service --}}
                <a href="{{ $business->sms_dashbord_url }}" target="_blank" title="@lang('SMS')"
                    data-toggle="tooltip" data-placement="bottom"
                    class="btn btn-flat pull-left m-8 btn-sm mt-10 btn-warning text-black">
                    <strong><i class="fa fa-comments fa-lg" aria-hidden="true"> @lang('SMS')</i></strong>
                </a>
            @else
            ...
            @if ($super_admin->enable_short_cut_purchase ==  1)
                @can('purchase.create')
                    <a href="{{ url('/purchases/pop') }}" target="_blank" title="POP" data-toggle="tooltip"
                        data-placement="bottom" class="btn btn-flat pull-left m-8 btn-sm mt-10 btn-success">
            ...
            @if (Module::has('Repair') && $business->repair == '1')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img class="img-responsive" src="{{ asset('img/sms_banner.jpeg') }}" />
            </div>
        </div>
    </div>
</div>
