<div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="modalTitle"> @lang('lang_v1.stock_adjustment_details') (<b>@lang('purchase.ref_no'):</b>
                ...
                <div class="col-sm-4 invoice-col">
                    ...
                    @if ($super_admin->advance_stock_adjustment != 0)
                        @if ($stock_adjustment->sub_type == 'decrease')
                            <b>Sub Type:</b> Stock Decrease<br>
						@else
						<b>Sub Type:</b> Stock Increase<br>
                        @endif
                    @endif
