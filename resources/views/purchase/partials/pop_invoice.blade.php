  ...
  <div class="row">
    <div class="col-sm-12 text-center">
      ...
      <address>
        ...
        <label for="" style="font-size: 22px;"><b>{{ $purchase->location->name }}</label></b>
      ...
      <div class="table-responsive">
        <table class="table">
          <tr>
            ...
            <td colspan="12"></td>
            <td class="pull-right">@lang('purchase.net_total_amount'):</td>
          ...
          <tr>
            ...
            <td colspan="12"></td>
            <td class="pull-right">@lang('purchase.purchase_total'):</td>
          ...
          <tr>
            ...
            <td><span class="display_currency pull-right" data-currency_symbol="true" >{{ $purchase->final_total + $purchase->change_return }}</span></td>
          </tr>
          <tr>
            {{-- <th>Change Return:</th> --}}
            <td colspan="12"></td>
            <td class="pull-right">Change Return:</td>
            <td><span class="display_currency pull-right" data-currency_symbol="true" >{{ $purchase->change_return }}</span></td>
          </tr>
        </table>
      </div>
    </div>
