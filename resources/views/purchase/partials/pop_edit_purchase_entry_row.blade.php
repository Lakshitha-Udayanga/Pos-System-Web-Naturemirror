    ...
    id="purchase_entry_table">
        <thead>
              <tr>
                ...
                <th class="@if(!session('business.enable_editing_product_from_purchase') || !empty($is_purchase_order)) hide @endif" hidden>
                    @lang( 'lang_v1.profit_margin' )
                </th>
                @if(empty($is_purchase_order))
                    <th hidden>@lang( 'purchase.unit_selling_price') <small>(@lang('product.inc_of_tax'))</small></th>
