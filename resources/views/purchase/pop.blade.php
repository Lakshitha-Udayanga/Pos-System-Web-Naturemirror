        ...
        <form action="/purchases/storepop">
            @component('components.widget', ['class' => 'box-solid'])
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="default_supplier_id" value="{{ $walk_in_supplier['id'] }}" hidden>
                                <input type="text" id="default_supplier_name" value="{{ $walk_in_supplier['name'] }}" hidden>
                    ...
                    <div class="hide col-sm-3 @if (!empty($default_purchase_status)) hide @endif">
                        <div class="form-group">
                    ...
                    <div class="hide @if (!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
                        <div class="form-group">
                    ...
                    <div class="hide col-sm-3 @if (!$currency_details->purchase_in_diff_currency) hide @endif">
                        <div class="form-group">
            ...
            @component('components.widget', ['class' => 'box-solid', 'title' => 'Select Products'])
                            ...
                            <table class="table table-condensed table-bordered table-th-green text-center table-striped"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th hidden>@lang('lang_v1.unit_cost_before_discount')</th>
                                        <th hidden>@lang('lang_v1.discount_percent')</th>
                                        <th>Unit Price</th>
                                        <th class="{{ $hide_tax }}" hidden>@lang('purchase.subtotal_before_tax')</th>
                                        <th class="{{ $hide_tax }}" hidden>@lang('purchase.product_tax')</th>
                                        <th class="{{ $hide_tax }}" hidden>@lang('purchase.net_cost')</th>
                                        <th>@lang('purchase.line_total')</th>
                                        <th class="@if (!session('business.enable_editing_product_from_purchase')) hide @endif" hidden>
            ...
            @component('components.widget', ['class' => 'box-solid hide', 'title' => 'Add Payment'])
                <div class="row ">
                    <div class="col-sm-12">
                        <table class="table">
                            <tr>
                                ...
                                <td class="col-md-3">
                                    ...
                                    {!! Form::text('final_total', 0, ['id' => 'grand_total_hidden']) !!}<br>
                        ...
                        <table class="table">
                            <tr>
                                <td class="col-md-3 hide">
                                    <div class="form-group">
                                        {!! Form::label('cash_tendard', __('Cash Tendard') . ':') !!}
                                        {!! Form::text('discount_amount', 0, ['class' => 'form-control cash_tenderd input_number', 'required']) !!}
                                    </div>
                                </td>
                                <td class="col-md-3">
                                    &nbsp;
                ...
                <div class="box-body payment_row">
                    @include('purchase.partials.payment_row_form', [
                        'row_index' => 0,
                        'show_date' => true,
...
@section('javascript')
    <script src="{{ asset('js/purchase_pop.js?v=' . $asset_v) }}"></script>
