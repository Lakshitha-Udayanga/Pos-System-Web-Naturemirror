            ...
            <div class="modal-dialog" role="document" style="width: 500px;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::file('import_cheques_csv', ['accept' => '.xls, .xlsx, .csv', 'required' => 'required']) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <br>
                        ...
                        <div class="col-sm-4">
                            <a href="{{ asset('files/import_cheques_csv_template.xls') }}" class="btn btn-primary" download><i class="fa fa-download"></i> @lang('lang_v1.download_template_file')</a>
                        </div>
                    </div>
