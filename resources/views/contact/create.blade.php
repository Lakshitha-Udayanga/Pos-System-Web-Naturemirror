  ...
  @endphp
    ...
    <div class="modal-body">
        <div class="row">            
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('mobile', __('contact.mobile') . ':*') !!} @show_tooltip(__('Enter contact number without 0'))
                    <div class="input-group">
                        <span class="input-group-addon">
                            +94
                            {{-- <i class="fa fa-mobile"></i> --}}
                        ...
                        {{-- {!! Form::text('mobile', null, ['class' => 'form-control', 'required', 'id' => 'contact_mobile', 'placeholder' => __('contact.mobile')]); !!} --}}
                    </div>
                </div>
            </div>
