    ...
    <section class="content">
                ...
                @if ($business->show_product_second_name == 1)
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('second_name', $product->second_name, [
                                'class' => 'form-control',
        ...
        @component('components.widget', ['class' => 'box-primary'])
            <div class="row">
                ...
                <div class="col-sm-3">
                    <label>
                        {!! Form::checkbox(
                            ...
                            ['class' => 'input-icheck'],
                        ) !!} <strong>@lang('Free Issues Enable')</strong>
                    </label> @show_tooltip(__('Free Issues Enable'))
                </div>
                <div class="col-sm-4 ">
                    <div class="form-group">
                        {!! Form::label('tax', __('Product QTY') . ':') !!}
                        {!! Form::text(
                            'product_qty',
                ...
                <div class="col-sm-4 ">
                    <div class="form-group">
                        {!! Form::label('tax', __('Free Issues QTY') . ':') !!}
                        {!! Form::text(
                            'free_qty',
