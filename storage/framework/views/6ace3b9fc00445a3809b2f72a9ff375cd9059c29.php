    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <?php echo Form::select('expense_category_id', $expense_categories, null, [
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo Form::select('expense_sub_category_id', [], null, [
                                'placeholder' => __('messages.please_select'),
                                'class' => 'form-control select2',
                            ]); ?>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?php echo Form::text('transaction_date', \Carbon::createFromTimestamp(strtotime('now'))->format(session('business.date_format') . ' ' . 'h:i A'), [
                                    'class' => 'form-control',
                                    'readonly',
                                    'required',
                ...
                ?>
                            <?php echo Form::select('expense_for', $users, null, [
                                'class' => 'form-control select2',
                                'placeholder' => __('messages.please_select'),
                            ]); ?>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <?php echo Form::text('final_total', null, [
        ...
        <div class="col-sm-12 text-center">
            <button type="submit" class="btn btn-primary btn-big" id="btn-big"><?php echo app('translator')->getFromJson('messages.save'); ?></button>
        </div>
        <?php echo Form::close(); ?>
...
<?php $__env->startSection('javascript'); ?>
    <script type="text/javascript">
        ...
        $(document).on('change', '.account-dropdown', function(e) {
            ...
            if (account != '') {
                $('#account_required').hide();
                $('#btn-big').prop('disabled', false);
            }
        });
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\My Project\Thand\free-isses-item\New folder\resources\views/expense/create.blade.php ENDPATH**/ ?>