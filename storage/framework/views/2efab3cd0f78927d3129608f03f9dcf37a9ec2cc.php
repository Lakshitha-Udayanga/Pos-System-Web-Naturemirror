    ...
    <section class="content">
        ...
        <div class="row">
                ...
                <?php $__env->startComponent('components.widget', ['title' => __('lang_v1.roles_and_permissions')]); ?>
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="checkbox">
                                <label>
                                    <?php echo Form::checkbox('allow_login', 1, true, ['class' => 'input-icheck', 'id' => 'allow_login']); ?> <?php echo e(__('lang_v1.allow_login'), false); ?>
                ...
                ?></h4>
                    ...
                    <div class="col-md-9">
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    <?php echo Form::checkbox('access_all_locations', 'access_all_locations', true, ['class' => 'input-icheck']); ?> <?php echo e(__('role.all_locations'), false); ?>
                ...
                ?>
                        ...
                        <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        <?php echo Form::checkbox('location_permissions[]', 'location.' . $location->id, false, ['class' => 'input-icheck']); ?> <?php echo e($location->name, false); ?> <?php if(!empty($location->location_id)): ?>
            ...
            <div class="col-md-12">
                ...
                ?>
                            <?php echo Form::text('cmmsn_percent', null, [
                ...
                ?>
                            <?php echo Form::text('max_sales_discount_percent', null, [
                                'class' => 'form-control input_number',
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="checkbox">
                                <br />
                                <label>
                                    <?php echo Form::checkbox('selected_contacts', 1, false, ['class' => 'input-icheck', 'id' => 'selected_contacts']); ?> <?php echo e(__('lang_v1.allow_selected_contacts'), false); ?>
                ...
                ?>
                    ...
                    <div class="col-sm-4 hide selected_contacts_div">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <?php echo Form::select('selected_contact_ids[]', [], null, [
        ...
        <script type="text/javascript">
            ...
            $('#username').change(function() {
                if ($('#show_username').length > 0) {
                    if ($(this).val().trim() != '') {
                        $('#show_username').html("<?php echo e(__('lang_v1.your_username_will_be'), false); ?>: <b>" + $(this).val() +
                            "<?php echo e($username_ext, false); ?></b>");
                    } else {
                        $('#show_username').html('');
                    }
                }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\Clicky Pos 4.7.8\POS-V4.7.8\resources\views/manage_user/create.blade.php ENDPATH**/ ?>