                    ...
                    if(typeof product_sell_report_by_category_datatable == 'undefined') {
                        product_sell_report_by_category_datatable = $('table#product_sell_report_by_category').DataTable({
                                ...
                                columns: [
                                    ...
                                    { data: 'total_free_issue_quantity', name: 'total_free_issue_quantity', searchable: false },
                                    { data: 'free_issues_amount', name: 'free_issues_amount', searchable: false },
                                ...
                                fnDrawCallback: function(oSettings) {
                                    ...
                                    $('#footer_psr_by_cat_free_issues_amount').text(
                                        sum_table_col($('#product_sell_report_by_category'), 'free_issues_amount')
                                    );
                                    $('#footer_psr_by_cat_total_sold').html(
                                        __sum_stock($('#product_sell_report_by_category'), 'sell_qty')
                                    );
                                    $('#footer_psr_by_free_total_stock').html(
                                        __sum_stock($('#product_sell_report_by_category'), 'free_qty')
                                    );
                    ...
                    if(typeof product_sell_report_by_brand_datatable == 'undefined') {
                        product_sell_report_by_brand_datatable = $('table#product_sell_report_by_brand').DataTable({
                                ...
                                fnDrawCallback: function(oSettings) {
                                    ...
                                    $('#footer_psr_by_brand_free_issues_amount').text(
                                        sum_table_col($('#product_sell_report_by_brand'), 'free_issues_amount')
                                    );
                                    $('#footer_psr_by_brand_total_sold').html(
                                        __sum_stock($('#product_sell_report_by_brand'), 'sell_qty')
                                    );
                                    $('#footer_psr_by_brand_free_total_stock').html(
                                        __sum_stock($('#product_sell_report_by_brand'), 'free_qty')
                                    );
                                    $('#footer_psr_by_cat_total_stock').html(
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\My Project\Thand\free-isses-item\New folder\resources\views/report/product_sell_report.blade.php ENDPATH**/ ?>