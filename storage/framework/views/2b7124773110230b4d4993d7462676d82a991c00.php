...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        <h1><?php echo app('translator')->getFromJson('purchase.add_purchase'); ?> <i class="fa fa-keyboard-o hover-q text-muted" aria-hidden="true" data-container="body"
                data-toggle="popover" data-placement="bottom" data-content="<?php echo $__env->make('purchase.partials.keyboard_shortcuts_details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>" data-html="true"
    ...
    <section class="content no-print">
        ...
        <form action="/purchases/storepop">
            <?php $__env->startComponent('components.widget', ['class' => 'box-solid']); ?>
                <div class="row">
                    <input type="text" name="is_pop_screen" value="1" hidden>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="default_supplier_id" value="<?php echo e($walk_in_supplier['id'], false); ?>" hidden>
                                <input type="text" id="default_supplier_name" value="<?php echo e($walk_in_supplier['name'], false); ?>" hidden>
                    ...
                    <div class="hide col-sm-3 <?php if(!empty($default_purchase_status)): ?> hide <?php endif; ?>">
                        <div class="form-group">
                ...
                ?>
                            <?php echo Form::select('status', $orderStatuses, $default_purchase_status, [
                    ...
                    <div class="hide <?php if(!empty($default_purchase_status)): ?> col-sm-4 <?php else: ?> col-sm-3 <?php endif; ?>">
                        <div class="form-group">
                ...
                ?>
                    ...
                    <div class="hide col-sm-3 <?php if(!$currency_details->purchase_in_diff_currency): ?> hide <?php endif; ?>">
                        <div class="form-group">
                ...
                ?>
                                ...
                                <?php echo Form::select('pay_term_type', ['months' => __('lang_v1.months'), 'days' => __('lang_v1.days')], null, [
            ...
            <?php $__env->startComponent('components.widget', ['class' => 'box-solid', 'title' => 'Select Products']); ?>
                <div class="col-sm-10 col-sm-offset-1">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button" class="btn btn-default btn-modal bg-white btn-flat pos_add_quick_product"
                            ...
                            <table class="table table-condensed table-bordered table-th-green text-center table-striped"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th hidden><?php echo app('translator')->getFromJson('lang_v1.unit_cost_before_discount'); ?></th>
                                        <th hidden><?php echo app('translator')->getFromJson('lang_v1.discount_percent'); ?></th>
                                        <th>Unit Price</th>
                                        <th class="<?php echo e($hide_tax, false); ?>" hidden><?php echo app('translator')->getFromJson('purchase.subtotal_before_tax'); ?></th>
                                        <th class="<?php echo e($hide_tax, false); ?>" hidden><?php echo app('translator')->getFromJson('purchase.product_tax'); ?></th>
                                        <th class="<?php echo e($hide_tax, false); ?>" hidden><?php echo app('translator')->getFromJson('purchase.net_cost'); ?></th>
                                        <th><?php echo app('translator')->getFromJson('purchase.line_total'); ?></th>
                                        <th class="<?php if(!session('business.enable_editing_product_from_purchase')): ?> hide <?php endif; ?>" hidden>
            ...
            <?php $__env->startComponent('components.widget', ['class' => 'box-solid hide', 'title' => 'Add Payment']); ?>
                <div class="row ">
                    <div class="col-sm-12">
                        <table class="table">
                            <tr>
                                ...
                                <td class="col-md-3">
                                    ...
                                    <?php echo Form::text('final_total', 0, ['id' => 'grand_total_hidden']); ?><br>
                                    <b><?php echo app('translator')->getFromJson('purchase.purchase_total'); ?>: </b><span id="grand_total" class="display_currency"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="tax_id" id="tax_id" class="form-control select2"
                                            ...
                                            <option value="" data-tax_amount="0" data-tax_type="fixed" selected>
                                                <?php echo app('translator')->getFromJson('lang_v1.none'); ?></option>
                        ...
                        <table class="table">
                            <tr>
                                <td class="col-md-3 hide">
                                    <div class="form-group">
                                        <?php echo Form::label('cash_tendard', __('Cash Tendard') . ':'); ?>

                                        <?php echo Form::text('discount_amount', 0, ['class' => 'form-control cash_tenderd input_number', 'required']); ?>
                ...
                <div class="box-body payment_row">
                    <?php echo $__env->make('purchase.partials.payment_row_form', [
                        'row_index' => 0,
                        'show_date' => true,
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="pull-right"><strong>Change Return:</strong> <span id="payment_due">0.00</span>
                            </div>
                        </div>
                    </div>
                    <br>
            ...
            <?php echo $__env->renderComponent(); ?>
            <div class="row">
                <input type="text" id="is_save_and_print" name="is_save_and_print" value="0" hidden>
                <div class="col-sm-12 text-center">
                    <button type="button" id="submit_purchase_form" class="btn btn-primary btn-big"><?php echo app('translator')->getFromJson('messages.save'); ?></button>
            ...
            <?php $__env->startComponent('components.widget', ['class' => 'box-solid hide']); ?>
                <div class="hide row">
                    <div class="col-md-4">
                        <div class="form-group">
                ...
                <div class="hide row">
                    <div class="col-md-12 text-center">
                        <button type="button" class="btn btn-primary btn-sm" id="toggle_additional_expense"> <i
                                class="fas fa-plus"></i> <?php echo app('translator')->getFromJson('lang_v1.add_additional_expenses'); ?> <i class="fas fa-chevron-down"></i></button>
                    </div>
...
<?php $__env->startSection('javascript'); ?>
    <script src="<?php echo e(asset('js/purchase_pop.js?v=' . $asset_v), false); ?>"></script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Clicky\Web POS\GitHub\POS-V4.7.8 -developer\resources\views/purchase/pop.blade.php ENDPATH**/ ?>