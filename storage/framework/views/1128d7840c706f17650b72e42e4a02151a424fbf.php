...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label><?php echo app('translator')->getFromJson('lang_v1.ledger_format'); ?></label>
            <div class="btn-group" data-toggle="buttons">
                <label class="btn btn-default active">
                    <input type="radio" name="ledger_format" value="format_1" checked> <?php echo app('translator')->getFromJson('lang_v1.format_1'); ?>
                </label>
                <label class="btn btn-default">
                    <input type="radio" name="ledger_format" value="format_2"> <?php echo app('translator')->getFromJson('lang_v1.format_2'); ?>
                </label>
            </div>
            </div>
        </div>
...
</div><?php /**PATH D:\Laravel Project\Clicky Pos 4.7.8\POS-V4.7.8\resources\views/contact/partials/ledger_tab.blade.php ENDPATH**/ ?>