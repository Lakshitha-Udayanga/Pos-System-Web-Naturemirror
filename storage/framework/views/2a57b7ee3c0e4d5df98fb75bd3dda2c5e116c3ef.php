<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <?php if($transaction->type != 'opening_balance'): ?>
                    ...
                    <div class="col-md-4">
                        <div class="well">
                            <strong><?php echo app('translator')->getFromJson('sale.total_amount'); ?>: </strong><span class="display_currency"
            ...
            <div class="row payment_row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::select('method', $payment_types, $payment_line->method, [
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::text('paid_on', \Carbon::createFromTimestamp(strtotime($payment_line->paid_on))->format(session('business.date_format') . ' ' . 'h:i A'), [
                                'class' => 'form-control',
                                'readonly',
                                'required',
                            ]); ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::text('amount', number_format($payment_line->amount, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), [
                ...
                <?php if(
                    ...
                    <input type="hidden" class="enable_cash_denomination_for_payment_methods"
                        value="<?php echo e(json_encode($pos_settings['enable_cash_denomination_for_payment_methods']), false); ?>">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = explode(',', $pos_settings['cash_denominations']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dnm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo Form::number("denominations[$dnm]", $count, [
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" class="denomination_total_amount"
                                                value="<?php echo e($total, false); ?>">
                                            <input type="hidden" class="is_strict"
                                                value="<?php echo e($pos_settings['cash_denomination_strict_check'] ?? '', false); ?>">
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="help-block"><?php echo app('translator')->getFromJson('lang_v1.previous_file_will_be_replaced'); ?>
                ...
                <?php if(!empty($accounts)): ?>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div id="account_required" style="color: red; font-weight: bold;" hidden><span>Account is
                                    required.!</span></div>
                        </div>
                    </div>
                <?php endif; ?>
        ...
        <div class="modal-footer">
            <button type="submit" class="btn btn-primary" id="update-payment"><?php echo app('translator')->getFromJson('messages.update'); ?></button>
...
<?php /**PATH F:\My Project\Thand\free-isses-item\New folder\resources\views/transaction_payment/edit_payment_row.blade.php ENDPATH**/ ?>