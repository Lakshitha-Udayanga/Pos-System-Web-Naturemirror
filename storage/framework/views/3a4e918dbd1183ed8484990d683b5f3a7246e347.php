<div class="col-xs-6">
    <?php $__env->startComponent('components.widget'); ?>
        <table class="table table-striped">
            ...
            <?php if($super_admin->enable_sale_bulk_return == 1): ?>
            <tr>
                <th><?php echo e(__('Total Bulk Sell Return'), false); ?>:</th>
                <td>
                    <span class="display_currency" data-currency_symbol="true"><?php echo e($data['total_bulk_return'], false); ?></span>
                </td>
            </tr>
            <?php endif; ?>
...
<div class="col-xs-6">
    <?php $__env->startComponent('components.widget'); ?>
        <table class="table table-striped">
            ...
            <tr>
                <th><?php echo e(__('Free Issues Amount'), false); ?>:</th>
                <td>
                    <span class="display_currency" data-currency_symbol="true"><?php echo e($data['free_issues_amount'], false); ?></span>
                </td>
            </tr>
            <tr>
                <td colspan="2">
...
<div class="col-xs-12">
    <?php $__env->startComponent('components.widget'); ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php if($super_admin->enable_sale_bulk_return == 1): ?>
            + <?php echo app('translator')->getFromJson('Total Bulk Retrun Refundable'); ?>
        <?php endif; ?> )
        </small>
    <?php echo $__env->renderComponent(); ?>
</div><?php /**PATH F:\My Project\Thand\free-isses-item\New folder\resources\views/report/partials/profit_loss_details.blade.php ENDPATH**/ ?>