...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header content-header-custom">
        <h1><?php echo e(__('home.welcome_message', ['name' => Session::get('user.first_name')]), false); ?>
            ...
            <div class="sms_div">
                <span for="" id="sms_balance"></span>
                <a href="#" title="<?php echo app('translator')->getFromJson('Refresh sms balance'); ?>" data-toggle="tooltip" data-placement="bottom" id="refresh_sms">
                    <i id="sms_refresh_icon" class=""></i>
                </a>
            </div>
        </h1>
    </section>
    ...
    <section class="content content-custom no-print">
        ...
        <?php if(auth()->user()->can('dashboard.data')): ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stock_report.view')): ?>
                <div class="row">
                    <div class="<?php if(session('business.enable_product_expiry') != 1 &&
                            auth()->user()->can('stock_report.view')): ?> col-sm-12 <?php else: ?> col-sm-6 <?php endif; ?>">
                        <?php $__env->startComponent('components.widget', ['class' => 'box-warning']); ?>
                            <?php $__env->slot('icon'); ?>
                                <i class="fa fa-exclamation-triangle text-yellow" aria-hidden="true"></i>
                            <?php $__env->endSlot(); ?>
                ...
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="' . __('tooltip.stock_expiry_alert', [ 'days'
            ...
            <?php endif; ?>
            <?php if(auth()->user()->can('so.view_all') ||
            ...
            $.ajax({
                ...
                success: function(result) {
                    if ($.trim(result)) {
                        ...
                        }else if (js.hasOwnProperty('userData')){
                            $("#sms_balance").text("Rs " + js.userData.walletBalance + " sms balance");
                            $("#sms_refresh_icon").attr("class", "fas fa-sync");
                        }else {
                            $("#sms_balance").text('');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\Clicky Pos 4.7.8\POS-V4.7.8\resources\views/home/index.blade.php ENDPATH**/ ?>