            ...
            <div class="row">
                <div class="col-sm-2 text-center">
                    <button type="button" class="btn btn-primary btn-flat" data-toggle="modal"
                        data-target="#import_purchase_products_modal"><?php echo app('translator')->getFromJson('product.import_products'); ?></button>
                </div>
                <div class="col-sm-8">
                    <div class="form-group">
                        <div class="input-group">
                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        <button tabindex="-1" type="button"
                            class="btn btn-link btn-modal"data-href="<?php echo e(action('ProductController@quickAdd'), false); ?>"
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <button type="button" id="submit_purchase_form"
                            class="btn btn-primary pull-right btn-flat"><?php echo app('translator')->getFromJson('messages.save'); ?></button>
                    </div>
                </div>
            </div>
        <?php echo $__env->renderComponent(); ?>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '.payment_types_dropdown, #location_id', function(e) {
            ...
            var account = $('.account-dropdown').val();
        ...
        $(document).on('change', '.account-dropdown', function(e) {
            var payment_types_dropdown = $('.payment_types_dropdown');
            var payment_type = payment_types_dropdown.val();
            if (payment_type == 'cheque') {
                $('#account_required').show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\My Project\Thand\free-isses-item\New folder\resources\views/purchase/create.blade.php ENDPATH**/ ?>