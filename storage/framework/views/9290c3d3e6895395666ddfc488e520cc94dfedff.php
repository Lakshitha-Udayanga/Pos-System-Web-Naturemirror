        ...
        <table class="table bg-gray">
          ...
          <?php $__currentLoopData = $purchase->purchase_lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase_line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td class="text-right"><span class="display_currency" data-is_quantity="true" data-currency_symbol="false"><?php echo e($purchase_line->quantity, false); ?></span> <?php if(!empty($purchase_line->sub_unit)): ?> <?php echo e($purchase_line->sub_unit->short_name, false); ?> <?php else: ?> <?php echo e($purchase_line->product->unit->short_name, false); ?> <?php endif; ?>
      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <tr>
            ...
            <td><span class="display_currency pull-right" data-currency_symbol="true" ><?php echo e($purchase->final_total + $purchase->change_return, false); ?></span></td>
          </tr>
          <tr>
            
            <td colspan="12"></td>
            <td class="pull-right">Change Return:</td>
            <td><span class="display_currency pull-right" data-currency_symbol="true" ><?php echo e($purchase->change_return, false); ?></span></td>
          </tr>
        </table>
      </div>
    </div>
...
</div><?php /**PATH F:\My Project\Thand\free-isses-item\New folder\resources\views/purchase/partials/pop_invoice.blade.php ENDPATH**/ ?>