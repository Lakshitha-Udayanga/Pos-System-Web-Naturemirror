            ...
            <div class="row">
                ...
                <?php if($business->show_product_second_name == 1): ?>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <?php echo Form::text('second_name', $product->second_name, [
                                'class' => 'form-control',
                ...
                ?>
                        ...
                        <select name="sub_unit_ids[]" class="form-control select2" multiple id="sub_unit_ids">
                            <?php $__currentLoopData = $sub_units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_unit_id => $sub_unit_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($sub_unit_id, false); ?>" <?php if(is_array($product->sub_unit_ids) && in_array($sub_unit_id, $product->sub_unit_ids)): ?> selected <?php endif; ?>>
                ...
                <div class="col-sm-4 <?php if(!session('business.enable_brand')): ?> hide <?php endif; ?>">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <?php echo Form::select('brand_id', $brands, $product->brand_id, [
                                'placeholder' => __('messages.please_select'),
                                'class' => 'form-control select2',
                            ]); ?>
                ...
                <div class="col-sm-4 <?php if(!(session('business.enable_category') && session('business.enable_sub_category'))): ?> hide <?php endif; ?>">
                    <div class="form-group">
                        ...
                        <?php echo Form::select('sub_category_id', $sub_categories, $product->sub_category_id, [
                            'placeholder' => __('messages.please_select'),
                            'class' => 'form-control select2',
                        ]); ?>
                ...
                ?>
                        <?php echo Form::text('alert_quantity', $alert_quantity, [
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <small>
                            <p class="help-block"><?php echo app('translator')->getFromJson('purchase.max_file_size', ['size' => config('constants.document_size_limit') / 1000000]); ?>. <?php echo app('translator')->getFromJson('lang_v1.aspect_ratio_should_be_1_1'); ?> <?php if(!empty($product->image)): ?>
                                    <br> <?php echo app('translator')->getFromJson('lang_v1.previous_image_will_be_replaced'); ?>
                                <?php endif; ?>
                            </p>
                        </small>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <label>
                        <?php echo Form::checkbox(
                            'free_issues_enable',
                            1,
                            !empty($product->free_issues_enable) ? $product->free_issues_enable : false,
                            ['class' => 'input-icheck'],
                ...
                <div class="col-sm-4 ">
                    <div class="form-group">
                        ...
                        <?php echo Form::text(
                            'product_qty',
                            !empty($free_items->product_qty) ? $free_items->product_qty : null,
                ...
                <div class="col-sm-4 ">
                    <div class="form-group">
                        ...
                        <?php echo Form::text(
                            'free_qty',
                            !empty($free_items->free_qty) ? $free_items->free_qty : null,
                            ['class' => 'form-control', 'placeholder'],
                        ); ?>
                ...
                <div class="text-center">
                    <div class="btn-group">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product.opening_stock')): ?>
                            <button type="submit" <?php if(empty($product->enable_stock)): ?> disabled="true" <?php endif; ?>
                                id="opening_stock_button" value="update_n_edit_opening_stock"
                                class="btn bg-purple submit_product_form"><?php echo app('translator')->getFromJson('lang_v1.update_n_edit_opening_stock'); ?></button>
                            <?php endif; ?>

                            <button type="submit" value="save_n_add_another"
                                class="btn bg-maroon submit_product_form"><?php echo app('translator')->getFromJson('lang_v1.update_n_add_another'); ?></button>

                            <button type="submit" value="submit"
                                class="btn btn-primary submit_product_form"><?php echo app('translator')->getFromJson('messages.update'); ?></button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\My Project\Thand\free-isses-item\New folder\resources\views/product/edit.blade.php ENDPATH**/ ?>