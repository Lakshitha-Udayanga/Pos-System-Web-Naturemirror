<table class="table table-bordered table-striped" id="purchase_table" style="width: 100%;">
    <thead>
        <tr>
            <th><input type="checkbox" id="select-all-purchase" data-table-id="purchase_table"></th>
...
</table><?php /**PATH E:\Clicky\Web POS\GitHub\POS-V4.7.8 -developer\resources\views/purchase/partials/purchase_table_form_pop.blade.php ENDPATH**/ ?>