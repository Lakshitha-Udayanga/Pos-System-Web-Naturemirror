...
<div class="payment_details_div <?php if( $payment_line->method !== 'cheque' ): ?> <?php echo e('hide', false); ?> <?php endif; ?>" data-type="cheque" >
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <?php echo Form::text(
                    ...
                    ['class' => 'form-control new_cheque_date', 'readonly', 'required'],
                ); ?>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="cheque_type"><?php echo app('translator')->getFromJson('account.cheque_type'); ?>:*</label>
...
</div><?php /**PATH F:\My Project\Thand\free-isses-item\New folder\resources\views/transaction_payment/payment_type_details.blade.php ENDPATH**/ ?>