        ...
        <table class="table table-responsive table-slim">
            <thead>
                <tr>
                    ...
                    <th class="text-right" width="15%">Free QTY</th>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $receipt_details->lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="text-right">
                            <?php if($line['free_issue_quantity']): ?>
                                <?php echo e($line['free_issue_quantity'], false); ?> <?php echo e($line['units'], false); ?>
...
<?php /**PATH F:\My Project\Thand\free-isses-item\New folder\resources\views/sale_pos/receipts/classic.blade.php ENDPATH**/ ?>