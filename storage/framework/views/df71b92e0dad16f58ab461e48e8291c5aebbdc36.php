            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <?php echo Form::text('paid_on', \Carbon::createFromTimestamp(strtotime($payment_line->paid_on))->format(session('business.date_format') . ' ' . 'h:i A'), ['class' => 'form-control', 'readonly', 'required' , 'id'=>'paid_on']);; ?>
      ...
      <?php /**PATH F:\My Project\Thand\free-isses-item\New folder\resources\views/sell_return/partials/payment_row.blade.php ENDPATH**/ ?>