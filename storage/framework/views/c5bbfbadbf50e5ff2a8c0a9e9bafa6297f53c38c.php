...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
                ...
                <table class="table table-bordered table-striped" id="contact_table">
                    ...
                    <tfoot>
                        <tr class="bg-gray font-17 text-center footer-total">
                            ...
                            <td></td>
                            <td></td>
                            <td <?php if($type == 'supplier'): ?> colspan="6"
                            <?php elseif($type == 'customer'): ?>
                                <?php if($reward_enabled): ?>
                                    colspan="9"
                                <?php else: ?>
        ...
        <div class="modal fade" id="modal_bulk_import_cheques" data-backdrop="false" data-keyboard="false" tabindex="-1"
            role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document" style="width: 500px;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title parameter_header">Bulk Import Cheques</h4>
                    ...
                    <div class="modal-body">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo Form::file('import_cheques_csv', ['accept' => '.xls, .xlsx, .csv', 'required' => 'required']); ?>
                                            ...
                                            <input type="text" name="contact_id" id="contact_id_for_import" hidden>
                                        </div>
                                    </div>
                                    <?php echo Form::close(); ?>
                        ...
                        <div class="col-sm-4">
                            <a href="<?php echo e(asset('files/import_cheques_csv_template.xls'), false); ?>" class="btn btn-primary" download><i class="fa fa-download"></i> <?php echo app('translator')->getFromJson('lang_v1.download_template_file'); ?></a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\Clicky Pos 4.7.8\POS-V4.7.8\resources\views/contact/index.blade.php ENDPATH**/ ?>