                    ...
                    <thead>
                        <tr>
                            <th>
                                ...
                                <?php else: ?>
                                    <?php echo app('translator')->getFromJson('category.category'); ?>
                                <?php endif; ?>
                            </th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\Clicky Pos 4.7.8\POS-V4.7.8\resources\views/taxonomy/index.blade.php ENDPATH**/ ?>