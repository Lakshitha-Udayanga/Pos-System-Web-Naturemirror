<div class="row">
    ...
    <div class="<?php echo e($col_class, false); ?>">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <?php echo Form::text("payment[$row_index][amount]", number_format($payment_line['amount'], session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), [
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <?php echo Form::text(
                        ...
                        isset($payment_line['paid_on']) ? \Carbon::createFromTimestamp(strtotime($payment_line['paid_on']))->format(session('business.date_format') . ' ' . 'h:i A') : \Carbon::createFromTimestamp(strtotime('now'))->format(session('business.date_format') . ' ' . 'h:i A'),
    ...
    <div class="<?php echo e($col_class, false); ?>">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                ?>
                <?php echo Form::select("payment[$row_index][method]", $payment_types, $_payment_method, [
                ...
                <?php if($readonly): ?>
                    <?php echo Form::hidden("payment[$row_index][method]", $payment_line['method'], [
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = explode(',', $pos_settings['cash_denominations']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dnm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo Form::number("payment[$row_index][denominations][$dnm]", $count, [
    ...
    <?php if(!empty($accounts)): ?>
        <div class="<?php echo e($col_class, false); ?>">
            <div class="form-group <?php if($readonly): ?> hide <?php endif; ?>">
				...
				<div id="account_required" style="color: red; font-weight: bold;"><span>Account is required.!</span></div>
            </div>
        </div>
    <?php endif; ?>
    <div class="clearfix"></div>
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <?php echo Form::textarea("payment[$row_index][note]", $payment_line['note'], [
                'class' => 'form-control',
                'rows' => 3,
                'id' => "note_$row_index",
            ]); ?>
...
<?php /**PATH F:\My Project\Thand\free-isses-item\New folder\resources\views/sale_pos/partials/payment_row_form.blade.php ENDPATH**/ ?>