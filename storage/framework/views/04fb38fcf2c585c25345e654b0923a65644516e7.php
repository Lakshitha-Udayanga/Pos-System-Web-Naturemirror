...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        <?php echo Form::open([
            'url' => action('ManageUserController@update', [$user->id]),
            'method' => 'PUT',
            'id' => 'user_edit_form',
        ]); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                            ...
                            <div class="checkbox">
                                <label>
                                    <?php echo Form::checkbox('allow_login', 1, !empty($user->allow_login), [
                                        'class' => 'input-icheck',
                                        'id' => 'allow_login',
                                    ]); ?> <?php echo e(__('lang_v1.allow_login'), false); ?>
                ...
                ?>
                            <?php echo Form::select('role', $roles, !empty($user->roles->first()->id) ? $user->roles->first()->id : null, [
                                ...
                                <div class="checkbox">
                                    <label>
                                        <?php echo Form::checkbox(
                                            ...
                                            ['class' => 'input-icheck'],
                                        ); ?> <?php echo e($location->name, false); ?> <?php if(!empty($location->location_id)): ?>
                                            (<?php echo e($location->location_id, false); ?>)
                                        <?php endif; ?>
                                    </label>
                                </div>
                            </div>
            ...
            <div class="col-md-12">
                ...
                ?>
                            <?php echo Form::text('cmmsn_percent', !empty($user->cmmsn_percent) ? number_format($user->cmmsn_percent, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']) : 0, [
                ...
                ?>
                            <?php echo Form::text(
                                ...
                                !is_null($user->max_sales_discount_percent) ? number_format($user->max_sales_discount_percent, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']) : null,
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="checkbox">
                                <br />
                                <label>
                                    <?php echo Form::checkbox('selected_contacts', 1, $user->selected_contacts, [
                                        'class' => 'input-icheck',
                ...
                ?>
                    ...
                    <div class="col-sm-4 selected_contacts_div <?php if(!$user->selected_contacts): ?> hide <?php endif; ?>">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <?php echo Form::select('selected_contact_ids[]', $contact_access, array_keys($contact_access), [
                                    'class' => 'form-control select2',
                                    'multiple',
                                    'style' => 'width: 100%;',
        ...
        <?php echo $__env->make('user.edit_profile_form_part', [
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Clicky\Web POS\GitHub\POS-V4.7.8 -developer\resources\views/manage_user/edit.blade.php ENDPATH**/ ?>