            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::select('type', $types, $contact->type, [
                                'class' => 'form-control',
                                'id' => 'contact_type',
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::text('contact_id', $contact->contact_id, [
                                'class' => 'form-control',
                ...
                <div class="col-md-4 customer_fields">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::select('customer_group_id', $customer_groups, $contact->customer_group_id, [
                                'class' => 'form-control',
                            ]); ?>
                ...
                <div class="col-md-4 business">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::text('supplier_business_name', $contact->supplier_business_name, [
                                'class' => 'form-control',
                ...
                <div class="col-md-3 individual">
                    <div class="form-group">
                        ...
                        <?php echo Form::text('prefix', $contact->prefix, [
                            'class' => 'form-control',
                ...
                <div class="col-md-3 individual">
                    <div class="form-group">
                        ...
                        <?php echo Form::text('first_name', $contact->first_name, [
                            'class' => 'form-control',
                            'required',
                ...
                <div class="col-md-3 individual">
                    <div class="form-group">
                        ...
                        <?php echo Form::text('middle_name', $contact->middle_name, [
                            'class' => 'form-control',
                ...
                <div class="col-md-3 individual">
                    <div class="form-group">
                        ...
                        <?php echo Form::text('last_name', $contact->last_name, [
                            'class' => 'form-control',
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <?php echo Form::label('mobile', __('contact.mobile') . ':*'); ?> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="' . __('Enter contact number without 0') . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>
                        <div class="input-group">
                            <span class="input-group-addon">
                            ...
                            <input type="text"
                                ...
                                class="form-control" id="contact_mobile" name="mobile" maxlength="9"
                                placeholder="Mobile" value="<?php echo e($contact->mobile, false); ?>" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::text('alternate_number', $contact->alternate_number, [
                                'class' => 'form-control',
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::text('landline', $contact->landline, [
                                'class' => 'form-control',
                ...
                <div class="col-sm-4">
                    <div class="form-group individual">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::text('dob', !empty($contact->dob) ? \Carbon::createFromTimestamp(strtotime($contact->dob))->format(session('business.date_format')) : null, [
                ...
                <div class="col-md-4 lead_additional_div">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::select('crm_source', $sources, $contact->crm_source, [
                                'class' => 'form-control',
                                'id' => 'crm_source',
                                'placeholder' => __('messages.please_select'),
                            ]); ?>
                ...
                <div class="col-md-4 lead_additional_div">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::select('crm_life_stage', $life_stages, $contact->crm_life_stage, [
                                'class' => 'form-control',
                                'id' => 'crm_life_stage',
                                'placeholder' => __('messages.please_select'),
                            ]); ?>
                ...
                <div class="col-md-6 lead_additional_div">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::select('user_id[]', $users, $lead_users, [
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?php echo Form::select('assigned_to_users[]', $users, $assigned_to_users, [
                                    'class' => 'form-control select2',
                ...
                <div class="col-md-12">
                    <button type="button" class="btn btn-primary center-block more_btn"
                        data-target="#more_div"><?php echo app('translator')->getFromJson('lang_v1.more_info'); ?> <i class="fa fa-chevron-down"></i></button>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?php echo Form::text('tax_number', $contact->tax_number, [
                                    'class' => 'form-control',
                ...
                ?>
                                <br />
                                <?php echo Form::number('pay_term_number', $contact->pay_term_number, [
                    ...
                    <div class="col-md-4 customer_fields">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?php echo Form::text('credit_limit', $contact->credit_limit != null ? number_format($contact->credit_limit, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']) : null, [
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php echo Form::text('address_line_1', $contact->address_line_1, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php echo Form::text('address_line_2', $contact->address_line_2, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?php echo Form::text('country', $contact->country, [
                                    'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?php echo Form::text('zip_code', $contact->zip_code, [
                                    'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo Form::text('custom_field1', $contact->custom_field1, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo Form::text('custom_field2', $contact->custom_field2, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo Form::text('custom_field3', $contact->custom_field3, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo Form::text('custom_field4', $contact->custom_field4, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo Form::text('custom_field5', $contact->custom_field5, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo Form::text('custom_field6', $contact->custom_field6, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo Form::text('custom_field7', $contact->custom_field7, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo Form::text('custom_field8', $contact->custom_field8, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo Form::text('custom_field9', $contact->custom_field9, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo Form::text('custom_field10', $contact->custom_field10, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-8 col-md-offset-2 shipping_addr_div mb-10">
                        ...
                        <?php echo Form::text('shipping_address', $contact->shipping_address, [
                            'class' => 'form-control',
                        ...
                        <div class="col-md-12 mb-12">
                            <div class="form-check">
                                <input type="checkbox" name="is_export" class="form-check-input"
                                    id="is_customer_export" <?php if(!empty($contact->is_export)): ?> checked <?php endif; ?>>
...
<?php /**PATH D:\Laravel Project\Clicky Pos 4.7.8\POS-V4.7.8\resources\views/contact/edit.blade.php ENDPATH**/ ?>