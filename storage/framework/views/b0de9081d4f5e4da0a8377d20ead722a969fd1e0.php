...
<div class="row">
    <div class="col-md-12">
        <?php if(!empty($categories)): ?>
            <div class="col-md-4 col-sm-12" id="product_category_div">
                        ...
                        <?php if(!empty($category['sub_categories'])): ?>
                            <optgroup label="<?php echo e($category['name'], false); ?>">
                                <?php $__currentLoopData = $category['sub_categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <option value="<?php echo e($sc['id'], false); ?>"><?php echo e($sc['name'], false); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </optgroup>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if(!empty($brands)): ?>
            <div class="col-md-4 col-sm-12" id="product_brand_div">
                <?php echo Form::select('size', $brands, null, [
                    'id' => 'product_brand',
                    'class' => 'select2',
                    'name' => null,
        ...
        <div class="col-sm-4 <?php if(empty($featured_products)): ?> hide <?php endif; ?>" id="feature_product_div">
            <button type="button" class="btn btn-primary btn-flat"
                id="show_featured_products"><?php echo app('translator')->getFromJson('lang_v1.featured_products'); ?></button>
        </div>
    </div>
</div>
<br>
...
<?php /**PATH F:\My Project\Thand\free-isses-item\New folder\resources\views/sale_pos/partials/pos_sidebar.blade.php ENDPATH**/ ?>