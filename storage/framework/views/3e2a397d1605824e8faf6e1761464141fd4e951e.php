...
<br>
	...
	<h1><?php echo app('translator')->getFromJson('stock_adjustment.decrease_qty'); ?></h1>
	<?php else: ?>
	...
	<div class="box box-solid">
		<div class="box-body">
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="form-group">
						<input type="hidden" name="incOrdesc" id="adjust_type" value="decrease">
					</div>
				</div>
			</div>
			<div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\Clicky Pos 4.7.8\POS-V4.7.8\resources\views/stock_adjustment/create.blade.php ENDPATH**/ ?>