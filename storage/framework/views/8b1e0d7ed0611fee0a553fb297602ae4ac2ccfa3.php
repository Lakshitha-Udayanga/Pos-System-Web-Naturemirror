<?php $__currentLoopData = $variations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr <?php if(!empty($purchase_order_line)): ?> data-purchase_order_id="<?php echo e($purchase_order_line->transaction_id, false); ?>" <?php endif; ?>>
        ...
        <?php if($enable_free_issue): ?>
            <td>
                <input type="text" name="purchases[<?php echo e($row_count, false); ?>][free_issue_quantity]"
                value="0.00"
                class="form-control input-sm input_number mousetrap" required
                data-rule-abs_digit=<?php echo e($check_decimal, false); ?>
...
<input type="hidden" id="row_count" value="<?php echo e($row_count, false); ?>"><?php /**PATH F:\My Project\Thand\free-isses-item\New folder\resources\views/purchase/partials/purchase_entry_row.blade.php ENDPATH**/ ?>