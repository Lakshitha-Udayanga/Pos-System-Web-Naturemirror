            ...
            <div class="col-md-3">
                ...
                ?>
                    <div class="input-group">
                        ...
                        <input type="text" onkeyup="if (event.srcElement.value.charAt(0) == '0') { event.srcElement.value = event.srcElement.value.slice(1); }" class="form-control" id="contact_mobile" name="mobile" maxlength="9" placeholder="Mobile" required>
...
</div><!-- /.modal-dialog --><?php /**PATH D:\Laravel Project\Clicky Pos 4.7.8\POS-V4.7.8\resources\views/contact/create.blade.php ENDPATH**/ ?>