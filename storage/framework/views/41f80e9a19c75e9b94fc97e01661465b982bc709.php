...
<div class="payment_details_div <?php if( $payment_line['method'] !== 'cheque' ): ?> <?php echo e('hide', false); ?> <?php endif; ?>" data-type="cheque" >
		...
		<div class="form-group">
			...
			<div class="input-group">
              <span class="input-group-addon">
				...
				<?php echo Form::text("payment[$row_index][cheque_issued_date]", isset($payment_line['paid_on']) ? \Carbon::createFromTimestamp(strtotime($payment_line['paid_on']))->format(session('business.date_format') . ' ' . 'H:i') : \Carbon::createFromTimestamp(strtotime('now'))->format(session('business.date_format') . ' ' . 'H:i'), ['class' => 'form-control new_cheque_date', 'readonly', 'required']);; ?>
	...
	<div class="col-md-6">
		<div class="form-group">
			<label for="cheque_type_<?php echo e($row_index, false); ?>"><?php echo app('translator')->getFromJson('Cheque Type'); ?>:*</label>
			<select class="form-control select2" style="width: 100%;" name="payment[<?php echo e($row_index, false); ?>][cheque_type]" required>
...
<?php endfor; ?><?php /**PATH D:\Laravel Project\Clicky Pos 4.7.8\POS-V4.7.8\resources\views/sale_pos/partials/payment_type_details.blade.php ENDPATH**/ ?>