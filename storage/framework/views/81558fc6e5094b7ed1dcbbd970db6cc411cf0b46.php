    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        <?php echo Form::label('slug', 'Category Slug:'); ?>
          ...
          <?php echo Form::text('slug', null, ['class' => 'form-control', 'placeholder' => 'Category Slug']);; ?>
...
</div><!-- /.modal-dialog --><?php /**PATH D:\Laravel Project\Clicky Pos 4.7.8\POS-V4.7.8\resources\views/taxonomy/create.blade.php ENDPATH**/ ?>