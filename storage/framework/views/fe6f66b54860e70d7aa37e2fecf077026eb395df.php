    ...
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-6 col-sm-6">
                <div class="m-6 mt-5" style="display: flex;">
                    <p><strong><?php echo app('translator')->getFromJson('sale.location'); ?>: &nbsp;</strong>
                        ...
                        <?php endif; ?> &nbsp; <span
                            class="curr_datetime"><?php echo e(\Carbon::createFromTimestamp(strtotime('now'))->format(session('business.date_format') . ' ' . 'H:i'), false); ?></span> <i
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <button title="<?php echo app('translator')->getFromJson('lang_v1.calculator'); ?>" id="btnCalculator" type="button"
                    class="btn btn-success btn-flat pull-right m-5 btn-xs mt-10 popover-default" data-toggle="popover"
                    data-trigger="click" data-content='<?php echo $__env->make('layouts.partials.calculator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>' data-html="true"
                    data-placement="bottom">
                    <strong><i class="fa fa-calculator fa-lg" aria-hidden="true"></i></strong>
                </button>

                <button type="button" class="btn btn-danger btn-flat m-6 btn-xs m-5 pull-right" id="return_sale"
                    title="<?php echo app('translator')->getFromJson('lang_v1.sell_return'); ?>" data-toggle="popover" data-trigger="click"
...
<?php /**PATH F:\My Project\Thand\free-isses-item\New folder\resources\views/layouts/partials/header-pos.blade.php ENDPATH**/ ?>