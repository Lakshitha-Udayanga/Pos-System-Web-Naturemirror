    ...
    <div class="row invoice-info">
        ...
        <div class="col-sm-4 invoice-col">
            ...
            <?php if(!empty($purchase->status)): ?>
                <b><?php echo app('translator')->getFromJson('purchase.purchase_status'); ?>:</b>
                <?php if($purchase->type == 'purchase_order'): ?>
                    <?php echo e($po_statuses[$purchase->status]['label'] ?? '', false); ?>

                <?php else: ?>
                    <?php echo e(__('lang_v1.' . $purchase->status), false); ?>
            ...
            <?php if(!empty($custom_labels['purchase']['custom_field_1'])): ?>
                <br><strong><?php echo e($custom_labels['purchase']['custom_field_1'] ?? '', false); ?>: </strong>
                <?php echo e($purchase->custom_field_1, false); ?>

            <?php endif; ?>
            <?php if(!empty($custom_labels['purchase']['custom_field_2'])): ?>
                <br><strong><?php echo e($custom_labels['purchase']['custom_field_2'] ?? '', false); ?>: </strong>
                <?php echo e($purchase->custom_field_2, false); ?>

            <?php endif; ?>
            <?php if(!empty($custom_labels['purchase']['custom_field_3'])): ?>
                <br><strong><?php echo e($custom_labels['purchase']['custom_field_3'] ?? '', false); ?>: </strong>
                <?php echo e($purchase->custom_field_3, false); ?>

            <?php endif; ?>
            <?php if(!empty($custom_labels['purchase']['custom_field_4'])): ?>
                <br><strong><?php echo e($custom_labels['purchase']['custom_field_4'] ?? '', false); ?>: </strong>
                <?php echo e($purchase->custom_field_4, false); ?>
            ...
            <?php if($purchase->type == 'purchase_order'): ?>
                ...
                <span
                    class="label <?php if(!empty($shipping_status_colors[$purchase->shipping_status])): ?> <?php echo e($shipping_status_colors[$purchase->shipping_status], false); ?> <?php else: ?> <?php echo e('bg-gray', false); ?> <?php endif; ?>"><?php echo e($shipping_statuses[$purchase->shipping_status] ?? '', false); ?></span><br>
                ...
                <?php if(!empty($purchase->shipping_custom_field_1)): ?>
                    <br><strong><?php echo e($custom_labels['shipping']['custom_field_1'] ?? '', false); ?>: </strong>
                    <?php echo e($purchase->shipping_custom_field_1, false); ?>

                <?php endif; ?>
                <?php if(!empty($purchase->shipping_custom_field_2)): ?>
                    <br><strong><?php echo e($custom_labels['shipping']['custom_field_2'] ?? '', false); ?>: </strong>
                    <?php echo e($purchase->shipping_custom_field_2, false); ?>

                <?php endif; ?>
                <?php if(!empty($purchase->shipping_custom_field_3)): ?>
                    <br><strong><?php echo e($custom_labels['shipping']['custom_field_3'] ?? '', false); ?>: </strong>
                    <?php echo e($purchase->shipping_custom_field_3, false); ?>

                <?php endif; ?>
                <?php if(!empty($purchase->shipping_custom_field_4)): ?>
                    <br><strong><?php echo e($custom_labels['shipping']['custom_field_4'] ?? '', false); ?>: </strong>
                    <?php echo e($purchase->shipping_custom_field_4, false); ?>

                <?php endif; ?>
                <?php if(!empty($purchase->shipping_custom_field_5)): ?>
                    <br><strong><?php echo e($custom_labels['shipping']['custom_field_5'] ?? '', false); ?>: </strong>
                    <?php echo e($purchase->shipping_custom_field_5, false); ?>
                    ...
                    <?php $__currentLoopData = $purchase->purchase_lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase_line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <?php if($purchase->type == 'purchase_order'): ?>
                                <td>
                                    <span class="display_currency" data-is_quantity="true"
                                        data-currency_symbol="false"><?php echo e($purchase_line->quantity - $purchase_line->po_quantity_purchased, false); ?></span>
                            ...
                            <td class="text-right"><span class="display_currency"
                                    data-currency_symbol="true"><?php echo e($purchase_line->pp_without_discount, false); ?></span></td>
                            <td class="text-right"><span
                                    class="display_currency"><?php echo e($purchase_line->discount_percent, false); ?></span> %</td>
                            <td class="no-print text-right"><span class="display_currency"
                                    data-currency_symbol="true"><?php echo e($purchase_line->purchase_price, false); ?></span></td>
                            <td class="no-print text-right"><span class="display_currency"
                                    data-currency_symbol="true"><?php echo e($purchase_line->quantity * $purchase_line->purchase_price, false); ?></span>
                            </td>
                            <td class="text-right"><span class="display_currency"
                                    data-currency_symbol="true"><?php echo e($purchase_line->item_tax, false); ?> </span> <br /><small>
                                    <?php if(!empty($taxes[$purchase_line->tax_id])): ?>
                                        ( <?php echo e($taxes[$purchase_line->tax_id], false); ?> )
                                </small>
                    <?php endif; ?>
                    </td>
                    <td class="text-right"><span class="display_currency"
                            data-currency_symbol="true"><?php echo e($purchase_line->purchase_price_inc_tax, false); ?></span></td>
                    <?php if($purchase->type != 'purchase_order'): ?>
                        <?php
                        ...
                        ?>
                        <td class="text-right"><span class="display_currency"
                                data-currency_symbol="true"><?php echo e($sp, false); ?></span></td>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $purchase->payment_lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment_line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                ...
                                <td><span class="display_currency"
                                        data-currency_symbol="true"><?php echo e($payment_line->amount, false); ?></span></td>
                                <td>
                                    <?php echo e($payment_types[$payment_line->method] ?? $payment_line->method, false); ?>

                                    <?php if($payment_line->method == 'cheque'): ?>
                                        <br />
                                        (<?php echo e($payment_line->cheque_number, false); ?>)
                                    <?php elseif($payment_line->is_return == 1): ?>
                                        <br />
                                        ( <?php echo e(__('lang_v1.change_return'), false); ?> )
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if($payment_line->note): ?>
            ...
            <td><span class="display_currency pull-right"><?php echo e($total_before_tax, false); ?></span></td>
                    ...
                    <?php if(!empty($purchase->additional_expense_value_1) && !empty($purchase->additional_expense_key_1)): ?>
                        <tr>
                            ...
                            <td><b>(+)</b></td>
                            <td><span
                                    class="display_currency pull-right"><?php echo e($purchase->additional_expense_value_1, false); ?></span>
                            </td>
                        </tr>
                    <?php endif; ?>
                    <?php if(!empty($purchase->additional_expense_value_2) && !empty($purchase->additional_expense_key_2)): ?>
                        <tr>
                            ...
                            <td><b>(+)</b></td>
                            <td><span
                                    class="display_currency pull-right"><?php echo e($purchase->additional_expense_value_2, false); ?></span>
                            </td>
                        </tr>
                    <?php endif; ?>
                    <?php if(!empty($purchase->additional_expense_value_3) && !empty($purchase->additional_expense_key_3)): ?>
                        <tr>
                            ...
                            <td><b>(+)</b></td>
                            <td><span
                                    class="display_currency pull-right"><?php echo e($purchase->additional_expense_value_3, false); ?></span>
                            </td>
                        </tr>
                    <?php endif; ?>
                    <?php if(!empty($purchase->additional_expense_value_4) && !empty($purchase->additional_expense_key_4)): ?>
                        <tr>
                            ...
                            <td><b>(+)</b></td>
                            <td><span
                                    class="display_currency pull-right"><?php echo e($purchase->additional_expense_value_4, false); ?></span>
                            </td>
                        </tr>
                    <?php endif; ?>
                    <tr>
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <p class="well well-sm no-shadow bg-gray">
                ...
                <?php if(!empty($purchase->shipping_custom_field_1)): ?>
                    <br><strong><?php echo e($custom_labels['purchase_shipping']['custom_field_1'] ?? '', false); ?>: </strong>
                    <?php echo e($purchase->shipping_custom_field_1, false); ?>

                <?php endif; ?>
                <?php if(!empty($purchase->shipping_custom_field_2)): ?>
                    <br><strong><?php echo e($custom_labels['purchase_shipping']['custom_field_2'] ?? '', false); ?>: </strong>
                    <?php echo e($purchase->shipping_custom_field_2, false); ?>

                <?php endif; ?>
                <?php if(!empty($purchase->shipping_custom_field_3)): ?>
                    <br><strong><?php echo e($custom_labels['purchase_shipping']['custom_field_3'] ?? '', false); ?>: </strong>
                    <?php echo e($purchase->shipping_custom_field_3, false); ?>

                <?php endif; ?>
                <?php if(!empty($purchase->shipping_custom_field_4)): ?>
                    <br><strong><?php echo e($custom_labels['purchase_shipping']['custom_field_4'] ?? '', false); ?>: </strong>
                    <?php echo e($purchase->shipping_custom_field_4, false); ?>

                <?php endif; ?>
                <?php if(!empty($purchase->shipping_custom_field_5)): ?>
                    <br><strong><?php echo e($custom_labels['purchase_shipping']['custom_field_5'] ?? '', false); ?>: </strong>
                    <?php echo e($purchase->shipping_custom_field_5, false); ?>
    ...
    <div class="row print_section">
        <div class="col-xs-12">
            <img class="center-block"
                src="data:image/png;base64,<?php echo e(DNS1D::getBarcodePNG($purchase->ref_no, 'C128', 2, 30, [39, 48, 54], true), false); ?>">
        </div>
    </div>
</div>
<?php /**PATH E:\Clicky\Web POS\GitHub\POS-V4.7.8 -developer\resources\views/purchase/partials/show_details.blade.php ENDPATH**/ ?>