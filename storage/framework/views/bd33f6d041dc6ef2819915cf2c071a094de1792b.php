<div class="modal-dialog" role="document">
  <div class="modal-content">
        ...
        <?php if(!empty($accounts)): ?>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div id="account_required" style="color: red; font-weight: bold;" hidden><span>Account is required.!</span></div>
            </div>
          </div>
        <?php endif; ?>
        <div class="col-md-4">
    ...
    <div class="modal-footer">
      <button type="submit" class="btn btn-primary" id="add_save"><?php echo app('translator')->getFromJson( 'messages.save' ); ?></button>
...
</script><?php /**PATH F:\My Project\Thand\free-isses-item\New folder\resources\views/transaction_payment/payment_row.blade.php ENDPATH**/ ?>