    ...
    $(document).ready( function() {
        ...
        function initializeTaxonomyDataTable() {
            ...
            if ($('#category_table').length) {
                ...
                var is_woocommerce_input = $('#is_woocommerce_input').val();
...
</script><?php /**PATH D:\Laravel Project\Clicky Pos 4.7.8\POS-V4.7.8\resources\views/taxonomy/taxonomies_js.blade.php ENDPATH**/ ?>