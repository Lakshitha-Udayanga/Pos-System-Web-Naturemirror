...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content no-print">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <?php $__env->startComponent('components.widget', ['class' => 'box-solid']); ?>
                    <?php echo Form::hidden('location_id', !empty($default_location) ? $default_location->id : null, [
                        'id' => 'location_id',
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <?php echo Form::select('types_of_service_id', $types_of_service, null, [
                                        'class' => 'form-control',
                ...
                ?>
                                ...
                                <small>
                                    <p class="help-block hide" id="price_group_text"><?php echo app('translator')->getFromJson('lang_v1.price_group'); ?>: <span></span></p>
                                </small>
                            </div>
                        </div>
                    ...
                    <div class="<?php if(!empty($commission_agent)): ?> col-sm-3 <?php else: ?> col-sm-4 <?php endif; ?>">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?php if(!empty($walk_in_customer['price_calculation_type']) &&
                            ...
                            <small class="text-danger hide contact_due_text"><strong><?php echo app('translator')->getFromJson('account.customer_due'); ?>:</strong>
                                <span></span></small>
                        </div>
                        <small>
                            <strong>
                ...
                ?>
                                <br />
                                <?php echo Form::number('pay_term_number', $walk_in_customer['pay_term_number'], [
                    ...
                    <?php if($sale_type != 'sales_order'): ?>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <?php echo Form::select('invoice_scheme_id', $invoice_schemes, $default_invoice_schemes->id, [
                                    'class' => 'form-control select2',
                                    'placeholder' => __('messages.please_select'),
                                ]); ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_invoice_number')): ?>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <?php echo Form::text('invoice_no', null, [
                                    'class' => 'form-control',
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <?php echo Form::file('sell_document', [
                                'id' => 'upload_document',
                    ...
                    <?php if((!empty($pos_settings['enable_sales_order']) && $sale_type != 'sales_order') || $is_order_request_enabled): ?>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <?php echo Form::select('sales_order_ids[]', [], null, [
                                    'class' => 'form-control select2',
                                    'multiple',
                                    'id' => 'sales_order_ids',
                                ]); ?>
                ...
                <?php $__env->startComponent('components.widget', ['class' => 'box-solid']); ?>
                    ...
                    <div class="row col-sm-12 pos_product_div" style="min-height: 0">
                        ...
                        <input type="hidden" name="sell_price_tax" id="sell_price_tax"
                            value="<?php echo e($business_details->sell_price_tax, false); ?>">
                    ...
                    <div class="col-md-4 <?php if($sale_type == 'sales_order'): ?> hide <?php endif; ?>">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?php echo Form::text('discount_amount', number_format($sales_discount, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), [
                                    ...
                                    'data-max-discount-error_msg' => __('lang_v1.max_discount_error_msg', [
                                        'discount' => $max_discount != '' ? number_format($max_discount, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']) : '',
                                    ]),
                                ]); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <?php echo Form::number('rp_redeemed_modal', 0, [
                ...
                <?php $__env->startComponent('components.widget', ['class' => 'box-solid']); ?>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo Form::textarea('shipping_details', null, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo Form::textarea('shipping_address', null, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?php echo Form::text('shipping_charges', number_format(0.0, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), [
                                    'class' => 'form-control input_number',
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo Form::file('shipping_documents[]', [
                ...
                <div class="col-md-12 mb-12">
                    <div class="form-check">
                        <input type="checkbox" name="is_export" class="form-check-input" id="is_export"
                            <?php if(!empty($walk_in_customer['is_export'])): ?> checked <?php endif; ?>>
        ...
        ?>
        <?php if((empty($status) || !in_array($status, ['quotation', 'draft']) || $is_enabled_download_pdf) &&
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sell.payments')): ?>
                ...
                ?>
                                    <div class="input-group">
                                        ...
                                        <?php echo Form::select('prefer_payment_method', $payment_types, 'cash', [
                                            'class' => 'form-control',
                                            'style' => 'width:100%;',
                                        ]); ?>
                ...
                ?>
                                    <div class="input-group">
                                        ...
                                        <?php echo Form::select('prefer_payment_account', $accounts, null, [
                                            'class' => 'form-control',
                                            'style' => 'width:100%;',
                                        ]); ?>
                    ...
                    <?php if(empty($status) || !in_array($status, ['quotation', 'draft'])): ?>
                        <div class="payment_row" <?php if($is_enabled_download_pdf): ?> id="payment_rows_div" <?php endif; ?>>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="pull-right"><strong><?php echo app('translator')->getFromJson('lang_v1.balance'); ?>:</strong> <span
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\Clicky Pos 4.7.8\POS-V4.7.8\resources\views/sell/create.blade.php ENDPATH**/ ?>