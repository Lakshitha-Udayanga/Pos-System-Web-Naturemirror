    ...
    <tr <?php if(!empty($purchase_order_line)): ?> data-purchase_order_id="<?php echo e($purchase_order_line->transaction_id, false); ?>" <?php endif; ?>>
        ...
        <td>
            ...
            <?php if($product->enable_stock == 1): ?>
                <br>
                <small class="text-muted" style="white-space: nowrap;"><?php echo app('translator')->getFromJson('report.current_stock'); ?>: <?php if(!empty($variation->variation_location_details->first())): ?>
                        <?php echo e(number_format($variation->variation_location_details->first()->qty_available, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?>

                    <?php else: ?>
                        0
                    <?php endif; ?> <?php echo e($product->unit->short_name, false); ?></small>
            <?php endif; ?>
        ...
        <td>
            ...
            <input type="text" name="purchases[<?php echo e($row_count, false); ?>][quantity]"
                ...
                <?php if(!empty($max_quantity)): ?> data-rule-max-value="<?php echo e($max_quantity, false); ?>"
                    data-msg-max-value="<?php echo e(__('lang_v1.max_quantity_quantity_allowed', ['quantity' => $max_quantity]), false); ?>" <?php endif; ?>>
            ...
            <input type="hidden" name="purchases[<?php echo e($row_count, false); ?>][product_unit_id]"
                value="<?php echo e($product->unit->id, false); ?>">
            ...
            <?php if(!empty($product->second_unit)): ?>
                ...
                <input type="text" name="purchases[<?php echo e($row_count, false); ?>][secondary_unit_quantity]" value=""
        ...
        <td class="<?php echo e($hide_tax, false); ?>" hidden>
        ...
        <td class="<?php echo e($hide_tax, false); ?>" hidden>
            <div class="input-group">
                <select name="purchases[<?php echo e($row_count, false); ?>][purchase_line_tax_id]"
                    class="form-control select2 input-sm purchase_line_tax_id" placeholder="'Please Select'">
                    <option value="" data-tax_amount="0" <?php if($hide_tax == 'hide'): ?> selected <?php endif; ?>>
                    ...
                    <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($tax->id, false); ?>" data-tax_amount="<?php echo e($tax->amount, false); ?>"
                            <?php if($tax_id == $tax->id && $hide_tax != 'hide'): ?> selected <?php endif; ?>><?php echo e($tax->name, false); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
        ...
        <td class="<?php echo e($hide_tax, false); ?>" hidden>
            ...
            ?>
            <?php echo Form::text('purchases[' . $row_count . '][purchase_price_inc_tax]', $dpp_inc_tax, [
        ...
        <td class="<?php if(!session('business.enable_editing_product_from_purchase') || !empty($is_purchase_order)): ?> hide <?php endif; ?>" hidden>
            <?php echo Form::text(
                ...
                <td style="text-align: left;">
                    ...
                    <?php if(!empty($expiry_period_type)): ?>
                        ...
                        <div class="input-group <?php if($hide_mfg): ?> hide <?php endif; ?>">
                            ...
                            <?php echo Form::text('purchases[' . $row_count . '][mfg_date]', $mfg_date, [
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::text('purchases[' . $row_count . '][exp_date]', $exp_date, [
...
<?php /**PATH E:\Clicky\Web POS\GitHub\POS-V4.7.8 -developer\resources\views/purchase/partials/purchase_entry_row_pop.blade.php ENDPATH**/ ?>