                ...
                @component('accounting::components.filters', ['title' => __('report.filters')])
                    <form method="get" action="{{ Request::url() }}">
                        <div class="modal-body">
                            ...
                            <div class="form-group @if (!count($_GET) > 0) d-none @endif">
                                <a class="btn btn-sm btn-success" href="{{ Request::url() }}">
                                    ...
                                    {{ trans_choice('accounting::lang.filter', 2) }}
                                </a>
                            </div>

                            <div class="form-group">
                                <label for="chart_of_account_id"
                                    class="control-label">{{ trans_choice('accounting::general.account', 1) }}</label>
                                ...
                                <select class="form-control select2" name="chart_of_account_id" v-model="chart_of_account_id"
                                    ...
                                    <option v-for="account in chart_of_accounts" :value="account.id">@{{ account.name }}
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="start_date"
                                        class="control-label">{{ trans_choice('accounting::lang.start_date', 1) }}</label>
                                    <input class="form-control datepicker" v-model="start_date" type="text" name="start_date"
                                ...
                                <div class="form-group col-md-6">
                                    <label for="end_date"
                                        class="control-label">{{ trans_choice('accounting::lang.end_date', 1) }}</label>
                                    <input class="form-control datepicker" v-model="end_date" type="text" name="end_date"
                        ...
                        <div class="modal-footer">
                            <button type="submit"
                                class="btn btn-primary">{{ trans_choice('accounting::lang.filter', 1) }}</button>
                        </div>
                    </form>
                @endcomponent
            </div>
                                            ...
                                            <tbody>
                                                @foreach ($data as $key)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ url('accounting/journal_entry/' . $key->transaction_number . '/show') }}">
                                                                <span>{{ $key->id }}</span> <i
                                                        ...
                                                        <td>
                                                            ...
                                                            <a
                                                                href="{{ url('accounting/journal_entry/' . $key->transaction_number . '/show') }}">
                                                                <span>{{ $key->business_location }}</span> <i
                                                                    class="fas fa-external-link-alt"></i>
                                                            </a>
                                                        </td>
                                                        <td>
