$(document).ready(function () {
    ...
    if ($('#sr_date_filter').length == 1) {
        ...
        sr_sales_report = $('table#sr_sales_report').DataTable({
            ...
            ajax: {
                ...
                data: function (d) {
                    ...
                    d.customer_id = $('#sr_customer_id').val();
                    d.payment_status = $('#sr_payment_status').val();
        ...
        // customer and payment status filter
        //Sales representive filter
        $('select#sr_customer_id, select#sr_payment_status').change(function () {
...
function updateStockAdjustmentReport() {
    ...
    $('.total_increase').html(loader);
    $('.total_descrease').html(loader);
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('.total_increase').html(__currency_trans_from_en(data.total_increase, true));
            $('.total_descrease').html(__currency_trans_from_en(data.total_descrease, true));
        },
    });
...
function salesRepresentativeTotalSales() {
    ...
    var data_expense = {
        ...
        location_id: $('select#sr_business_id').val(),
        customer_id: $('#sr_customer_id').val(),
        payment_status: $('#sr_payment_status').val(),
        start_date: start,
        end_date: end,
    };
