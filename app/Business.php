...
class Business extends Model
{
    ...
    protected $appends = ['login_image_url'];
    ...
    /**
     * Get the Login Image on Superadmin Panel.
     *
     * @return string
     */
    public function getLoginImageUrlAttribute()
    {
        if (!empty($this->login_image)) {
            $login_image_url = asset('/uploads/login_images/' . rawurlencode($this->login_image));
        } else {
            $login_image_url = asset('/img/home-bg.jpg');
        }
