...
class BusinessLocationController extends Controller
{
    ...
    public function index()
    {
        ...
        //check location activation code if exists
        $get_code = Business::first();
        $is_available_location = $get_code->is_available_location;
        ...
        return view('business_location.index')->with(compact('is_available_location'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            //clear location activate code
            Business::where('id', $business_id)
                ->update([
                    'is_available_location' => 'no',
                    'location_activate_code' => null
                ]);
    ...
    */
    ...
    public function locationActivate(Request $request)
    {

        try {
            $input_code = $request->activation_code;

            //get database activation code
            $business_id = request()->session()->get('user.business_id');

            $location_activate_code = Business::where('id', $business_id)->first();

            if ($input_code == $location_activate_code->location_activate_code) {

                $location_activate_code->is_available_location = 'yes';
                $location_activate_code->save();
