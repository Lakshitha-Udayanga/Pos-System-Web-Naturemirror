...
class PurchaseController extends Controller
{
    ...
    public function create()
    {
        ...
        //enable free issue
        $enable_free_issue = $business_details->enable_free_issue;

        return view('purchase.create')
            ->with(compact('taxes', 'orderStatuses', 'business_locations', 'currency_details', 'default_purchase_status', 'customer_groups', 'types', 'shortcuts', 'payment_line', 'payment_types', 'accounts', 'bl_attributes', 'common_settings', 'enable_free_issue'));
    }
